...
import com.persitencia.Evaluacion;
 ...
 */
@Stateless
@Path("com.persitencia.evaluacion")
public class EvaluacionFacadeREST extends AbstractFacade<Evaluacion> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Evaluacion entity) {
        super.edit(entity);
    }
    ...
    public Evaluacion find(@PathParam("id") Integer id) {
